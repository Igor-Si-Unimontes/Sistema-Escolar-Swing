 ...
 * @author maylo
 */
public class AlterarDadosAluno extends javax.swing.JPanel {

    /**
     * Creates new form AlterarDadosAluno
     */
   
     public AlterarDadosAluno(Aluno aluno) {
        initComponents();
   ...
   public void LimparTela() {
    ...
    private void initComponents() {
        ...
        CampoEndereço.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void BotaoAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoAlterarMouseClicked
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Dados Alterado");
            LimparTela();
        } catch (DAOexception ex) {
            System.out.println("Erro criacao statement: " + ex);
            System.exit(0);
        } catch (SQLException ex) {
            Logger.getLogger(AlterarDadosAluno.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void BotaoVoltarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoVoltarMouseClicked
        ...
        AlterarAluno alteracoes = new AlterarAluno();
