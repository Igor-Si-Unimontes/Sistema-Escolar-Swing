...
public class AlterarDadosMateria extends javax.swing.JPanel {

    public AlterarDadosMateria(Materia materia) {
        initComponents();
        CampoId.setText(materia.getId());
        CampoNomeMateria.setText(materia.getNome());
        CampoPeriodo.setText("" + materia.getPeriodo());
        CampoNomeProfessor.setText(materia.getProfessor());
        CampoNomeCurso.setText(materia.getCurso());
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Alterar Dados Matéria");
        ...
        usuario4.setText("Digite o Nome da Matéria:");

        CampoNomeMateria.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        CampoNomeMateria.setForeground(new java.awt.Color(0, 0, 0));
        ...
        usuario5.setText("Digite o Período da Matéria:");
        ...
        usuario8.setText("Digite o Nome do Professor:");

        CampoNomeProfessor.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        CampoNomeProfessor.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PainelAlterarMateriaLayout.setHorizontalGroup(
            ...
            .addGroup(PainelAlterarMateriaLayout.createSequentialGroup()
                .addGap(70, 70, 70)
                .addComponent(usuario9, javax.swing.GroupLayout.PREFERRED_SIZE, 360, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(PainelAlterarMateriaLayout.createSequentialGroup()
                .addGap(70, 70, 70)
                .addComponent(CampoNomeCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 348, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(PainelAlterarMateriaLayout.createSequentialGroup()
                .addGap(70, 70, 70)
                .addComponent(jSeparator13, javax.swing.GroupLayout.PREFERRED_SIZE, 347, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void CampoNomeCursoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CampoNomeCursoMousePressed
        if (CampoNomeCurso.getText().equals("Ex : Sistemas de Informação")) {
    ...
    /*
    CampoNomeMateriate void CampoEmail2ActionPCampoNomeMateriaava.awt.event.ActionEvent evt) {//GEN-FIRST:event_CampoEmail2ActionPerformed
            // TODO add your handling code here:
...
*/
    private void BotaoAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoAlterarMouseClicked
        ...
        try {
            ...
            materiaController.update(id, nomeMateria, periodo, nomeProfessor, nomeCurso);
